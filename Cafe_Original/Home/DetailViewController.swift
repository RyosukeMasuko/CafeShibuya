...
//        removeButton.isEnabled = false
        ...
        //ConfigureShadowItem.button(shadowButton: shadow3Button)
//        confirmContent()
        ...
        query?.findObjectsInBackground({ (result, error) in
            if error != nil {
                ...
                for cafeInfoObject in result as! [NCMBObject] {
                    ...
                    let cafeInfo = CafeInfo(objectId: cafeInfoObject.objectId, basicInfo: basicInfo, introduction: introduciton, money: money, phoneNumber: phoneNumber, time: time, web: web,text: text, imageUrl: imageUrl as! String, streetAdress: streetAdress, geoPoint: geoPoint)
